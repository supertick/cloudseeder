...
class Config(BaseModel):
    ...
    queue_input_url: Optional[str] = Field(None, description="SQS Queue URL", example="https://sqs.us-west-2.amazonaws.com/123456789012/input-queue")
    queue_output_url: Optional[str] = Field(None, description="SQS Queue URL", example="https://sqs.us-west-2.amazonaws.com/123456789012/outpu-queue")
