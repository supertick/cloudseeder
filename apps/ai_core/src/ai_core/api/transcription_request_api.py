...
def get_all_transcription_requests(db: NoSqlDb = Depends(get_db), user: dict = Depends(require_role([]))):
...
def get_transcription_request(id: str, db: NoSqlDb = Depends(get_db), user: dict = Depends(require_role([]))):
